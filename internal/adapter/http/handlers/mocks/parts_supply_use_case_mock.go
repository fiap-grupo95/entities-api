...
// AuthorizeReserve mocks base method.
func (m *MockIPartsSupplyUseCase) AuthorizeReserve(ctx context.Context, partsSupply []entities.PartsSupply) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AuthorizeReserve", ctx, partsSupply)
	ret0, _ := ret[0].(error)
	return ret0
}

// AuthorizeReserve indicates an expected call of AuthorizeReserve.
func (mr *MockIPartsSupplyUseCaseMockRecorder) AuthorizeReserve(ctx, partsSupply any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AuthorizeReserve", reflect.TypeOf((*MockIPartsSupplyUseCase)(nil).AuthorizeReserve), ctx, partsSupply)
}
...
func (m *MockIPartsSupplyUseCase) Release(ctx context.Context, partsSupply []entities.PartsSupply) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Release", ctx, partsSupply)
	ret0, _ := ret[0].(error)
	return ret0
}

// Release indicates an expected call of Release.
func (mr *MockIPartsSupplyUseCaseMockRecorder) Release(ctx, partsSupply any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Release", reflect.TypeOf((*MockIPartsSupplyUseCase)(nil).Release), ctx, partsSupply)
}

// Reserve mocks base method.
func (m *MockIPartsSupplyUseCase) Reserve(ctx context.Context, partsSupply []entities.PartsSupply) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Reserve", ctx, partsSupply)
	ret0, _ := ret[0].(error)
	return ret0
}

// Reserve indicates an expected call of Reserve.
func (mr *MockIPartsSupplyUseCaseMockRecorder) Reserve(ctx, partsSupply any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Reserve", reflect.TypeOf((*MockIPartsSupplyUseCase)(nil).Reserve), ctx, partsSupply)
}
...
func (m *MockIPartsSupplyUseCase) WriteOff(ctx context.Context, partsSupply []entities.PartsSupply) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WriteOff", ctx, partsSupply)
	ret0, _ := ret[0].(error)
	return ret0
}

// WriteOff indicates an expected call of WriteOff.
func (mr *MockIPartsSupplyUseCaseMockRecorder) WriteOff(ctx, partsSupply any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WriteOff", reflect.TypeOf((*MockIPartsSupplyUseCase)(nil).WriteOff), ctx, partsSupply)
}
